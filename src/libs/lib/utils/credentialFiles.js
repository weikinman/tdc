...
export const hasCredentialFile = (filename) => {
	let d = '';
	try {
		d = credentialDir();
	} catch (error) {
...
export function credentialFile(filename) {
...
export function readCredentialFile(filename, defaultValue = '') {
	try {
...
export function readCredentialFileJson(filename, defaultValue = null) {
