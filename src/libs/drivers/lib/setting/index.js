...
import SyncTargetRegistry from '../SyncRegiest';
...
export const SettingSectionSource = {
	Default : 1,
	Plugin : 2,
}


export const SyncStartupOperation = {
	None : 0,
...
export const SettingItemSubType = {
...
class Setting extends BaseModel {
	...
	static schemaUrl = 'https://joplinapp.org/schema/settings.json';

	// For backward compatibility
	static TYPE_INT = SettingItemType.Int;
	static TYPE_STRING = SettingItemType.String;
	static TYPE_BOOL = SettingItemType.Bool;
	static TYPE_ARRAY = SettingItemType.Array;
	static TYPE_OBJECT = SettingItemType.Object;
	static TYPE_BUTTON = SettingItemType.Button;

	static THEME_LIGHT = 1;
	static THEME_DARK = 2;
	static THEME_OLED_DARK = 22;
	static THEME_SOLARIZED_LIGHT = 3;
	static THEME_SOLARIZED_DARK = 4;
	static THEME_DRACULA = 5;
	static THEME_NORD = 6;
	static THEME_ARITIM_DARK = 7;

	static FONT_DEFAULT = 0;
	static FONT_MENLO = 1;
	static FONT_COURIER_NEW = 2;
	static FONT_AVENIR = 3;
	static FONT_MONOSPACE = 4;

	static LAYOUT_ALL = 0;
	static LAYOUT_EDITOR_VIEWER = 1;
	static LAYOUT_EDITOR_SPLIT = 2;
	static LAYOUT_VIEWER_SPLIT = 3;

	static DATE_FORMAT_1 = 'DD/MM/YYYY';
	static DATE_FORMAT_2 = 'DD/MM/YY';
	static DATE_FORMAT_3 = 'MM/DD/YYYY';
	static DATE_FORMAT_4 = 'MM/DD/YY';
	static DATE_FORMAT_5 = 'YYYY-MM-DD';
	static DATE_FORMAT_6 = 'DD.MM.YYYY';
	static DATE_FORMAT_7 = 'YYYY.MM.DD';
	static DATE_FORMAT_8 = 'YYMMDD';
	static DATE_FORMAT_9 = 'YYYY/MM/DD';

	static TIME_FORMAT_1 = 'HH:mm';
	static TIME_FORMAT_2 = 'h:mm A';
	static TIME_FORMAT_3 = 'HH.mm';

	static SHOULD_REENCRYPT_NO = 0; // Data doesn't need to be re-encrypted
	static SHOULD_REENCRYPT_YES = 1; // Data should be re-encrypted
	static SHOULD_REENCRYPT_NOTIFIED = 2; // Data should be re-encrypted, and user has been notified

	static SYNC_UPGRADE_STATE_IDLE = 0; // Doesn't need to be upgraded
	static SYNC_UPGRADE_STATE_SHOULD_DO = 1; // Should be upgraded, but waiting for user to confirm
	static SYNC_UPGRADE_STATE_MUST_DO = 2; // Must be upgraded - on next restart, the upgrade will start

	static customCssFilenames = {
	...
	static allowFileStorage = true;

	static metadata_ = null;
	// eslint-disable-next-line @typescript-eslint/no-explicit-any -- Old code before rule was applied
	static keychainService_ = null;
	static keys= null;
	static cache_ = [];
	// eslint-disable-next-line @typescript-eslint/no-explicit-any -- Old code before rule was applied
	static saveTimeoutId_ = null;
	// eslint-disable-next-line @typescript-eslint/no-explicit-any -- Old code before rule was applied
	static changeEventTimeoutId_ = null;
	static customMetadata_ = {};
	static customSections_ = {};
	static changedKeys= [];
	static fileHandler_ = null;
	static rootFileHandler_ = null;
	...
	static metadata() {
		...
		const emptyDirWarning = ('Attention: If you change this location, make sure you copy all your content to it before syncing, otherwise all files will be removed! See the FAQ for more details: %s', 'https://joplinapp.org/help/faq');

		// A "public" setting means that it will show up in the various config screens (or config command for the CLI tool), however
		// if if a setting might still be handled and modified by the app. For instance, the settings related to sorting notes are not
		// for the mobile and desktop apps because they are handled separately in menus.
